...
public class EmpCRUDController {
	...
	// public String deleteEmployee(@PathVariable int empno, Model model) {
	// System.out.println("Delete Employee Page Requested");
	// // delete employee using DAO
	// boolean b = edao.deleteEmployee(empno);
	//
	// // set it to the model
	// if (b) {
	// model.addAttribute("empid", empno);
	// }
	...
	public ResponseEntity<?> deleteEmployee(@RequestParam("id") int id) {
		...
		if (edao.deleteEmployee(employee)) {
	...
	public String deleteEmployee(Model model) {
		System.out.println("Deleted controller called");
		return "del";
	}
}